...
### Отличие реализации:
1. Данный репозиторий представляет собой **полностью самостоятельную разработку с нуля** (clean-room implementation), ориентированную на универсальный модульный пайплайн и поддержку русскоязычных видеоматериалов.
