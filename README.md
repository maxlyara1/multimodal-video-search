...
Первоначальный прототип был создан в рамках совместного хакатона ИТМО × ЦУ («ИИ Чемп 2026») для кейса Okko. После хакатона я индивидуально переработал и расширил его до универсальной исследовательской системы.

- **Мой вклад**: Постановка задачи, проектирование архитектуры, выбор моделей, подготовка эксперимента, оценка результатов и итоговая интеграция системы. При написании кода, интерфейса, тестов и документации в качестве вспомогательных инструментов разработки я использовал ИИ-агентов.
