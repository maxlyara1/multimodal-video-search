...
- **Multimodal (Max-per-Modality)**: Hit@1 = **70.00%**, Hit@3 = **90.00%** (на текущем development-наборе с замороженной декомпозицией запросов Max-per-Modality улучшил Hit@3 на один запрос; результат предварительный и требует проверки на независимой тестовой выборке)
- **Multimodal (RRF слияние)**: Hit@1 = 60.00%, Hit@3 = 70.00% (улучшает Sum по Hit@1, но не достигает baseline)
