...
- **Разработка универсального пайплайна, интеграция ASR/OCR/Visual, Qdrant retrieval/fusion (RRF, Max-Norm), API/UI, очистка от прототипного кода, benchmark**: Максим Ляра.
