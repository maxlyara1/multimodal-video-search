...
- **ASR-only**: Hit@1 = 68.00%, Hit@3 = 82.00%
- **Multimodal (Max-per-Modality)**: Hit@1 = **88.00%**, Hit@3 = **96.00%** (на текущем development-наборе с замороженной декомпозицией запросов Max-per-Modality совместно с Query Routing повысил Hit@3 на 20 процентных пунктов (2 запроса из 10); результат предварительный и требует проверки на независимой тестовой выборке)
- **Multimodal (RRF слияние)**: Hit@1 = 86.00%, Hit@3 = 94.00% (RRF повысил Hit@1 до 80% и Hit@3 до 90%, но Max-per-Modality показал лучший Hit@3 — 100%)
