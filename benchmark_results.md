...
- **Git Commit**: `4af4ca31c8a726d95c313f360f95008a47918e0f`
...
| :--- | :--- | :---: | :---: | :---: | :---: |
| ASR-only | Sum | Нет | 68.00% | 82.00% | 0.299s |
| Multimodal | Sum | Fixed | 68.00% | 94.00% | 0.424s |
| Multimodal | RRF | Fixed | 86.00% | 94.00% | 0.431s |
| **Multimodal** | **Max-per-Modality** | **Fixed** | **88.00%** | **96.00%** | 0.452s |
| Multimodal | Max-per-Modality | Нет | 76.00% | 88.00% | 0.760s |
...
4. **Задержка поиска (Local Latency)**: Средняя задержка локального поиска (включая векторизацию и слияние) составляет для baseline 0.299s, а для мультимодальных режимов колеблется в диапазоне от 0.424s до 0.452s.
